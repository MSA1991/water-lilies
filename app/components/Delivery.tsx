      ...
      <div className="section-py container relative z-0">
        <div className="w-full md:w-2/3 lg:w-1/2">
          ...
          <p className="my-5 font-bold md:my-7 md:text-xl">
            ...
            Після оформлення замовлення ми обов`язково зв`яжемося з Вами.
            Оплачене замовлення буде відправлено протягом 2-3 робочих днів.
            <br />
            <br />
