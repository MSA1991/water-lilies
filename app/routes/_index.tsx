...
export const meta: MetaFunction = () => {
  return [
    {
      title:
        'Купить нимфеи (водяные лилии, кувшинки) для пруда в Украине | Nymphaea Shop',
    },
    {
      name: 'description',
      content:
        'Купити німфеї, водяні лілії, латаття, рослини для водойм! Різноманіття сортів, кращі ціни та швидка доставка по всій Україні «Новою Поштою». Тел: +38 (066) 691-59-82',
    },
    {
      property: 'og:title',
      content:
        'Купити німфеї (водяні лілії, латаття) для ставка! Доставка по всій Україні',
    },
    {
    ...
    { property: 'og:site_name', content: 'Nymphaea Shop' },
  ];
};
