...
export const meta: MetaFunction = () => {
  return [
    {
      title:
        'Купити німфеї (водяні лілії, латаття) для ставка! Доставка по Україні | Nymphaea Shop',
    },
    {
      name: 'description',
      content:
        'Купити німфеї, (водяні лілії, латаття, кувшинки) рослини для водойм! Різноманіття сортів, кращі ціни та швидка доставка по всій Україні «Новою Поштою». Тел: +38 (066) 691-59-82',
    },
    {
      name: 'robots',
